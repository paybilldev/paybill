...
import { randomStr } from '../../src/utils/general';
        ...
        fields: [
          {
            ...
            validation: {
              ...
              rules: [
                ...
                { key: `r_${uid()}`, name: 'min', args: { length: 2 } },
                { key: `r_${uid()}`, name: 'max', args: { length: 5 } },
    ...
    beforeEach(async () => {
      User = db.collection({
        ...
        fields: [
          ...
          { type: 'belongsTo', name: 'group', target: 'groups' },
          { type: 'string', name: 'name' },
        ],
      });
        ...
        fields: [
          {
            ...
            validation: {
              type: 'string',
              rules: [{ key: `r_${uid()}`, name: 'length', args: { length: 2 } }],
            },
          },
        ],
      });
