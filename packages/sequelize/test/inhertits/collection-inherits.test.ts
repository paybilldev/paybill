import { isPg } from '../../src/utils/general';
import { BelongsToManyRepository, mockDatabase, Sequelize } from '../../src';
...
describe.runIf(isPg())('collection inherits', () => {
  ...
  it('should create inherited table', async () => {
    ...
    expect(studentTableInfo[getField('created_at')]).toBeDefined();
    expect(studentTableInfo[getField('updated_at')]).toBeDefined();
  });
