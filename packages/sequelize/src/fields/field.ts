...
export type FieldValidationRuleName = string;

export interface FieldValidationRule<T extends string = string> {
  key: string;
  name: FieldValidationRuleName;
  args?: {
    [key: string]: any;
  };
  paramsType?: 'object';
...
export interface ValidationOptions<T extends string = string> {
  type: T;
  rules: FieldValidationRule<T>[];
  [key: string]: any;
}

export interface BaseFieldOptions<T extends string = string> {
  name?: string;
  hidden?: boolean;
  translation?: boolean;
...
export interface BaseColumnFieldOptions<T extends string = string>
